...
//  */
// export function searchForPage(url: URL, manifest: ManifestData, astroConfig: AstroConfig): RouteData | undefined {
//   return manifest.routes.find((route) => route.pattern.test(url.pathname));
